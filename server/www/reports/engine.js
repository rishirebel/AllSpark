			...
			for (const parameter of externalParameters) {
				...
				if ((constants.filterPrefix + parameter.name) in this.request.body) {
					...
					this.filters.push({
						...
						value: filterParameter == null || filterParameter == undefined || isNaN(filterParameter) ? parameter.value : filterParameter,
						default_value: filterParameter == null || filterParameter == undefined || isNaN(filterParameter) ? parameter.value : filterParameter,
					})
				}
			}
